...
public class MaximizeTheDistanceBetweenPointsOnASquare {
    ...
    public static void main(String[] args) {
        MaximizeTheDistanceBetweenPointsOnASquare solver =
                new MaximizeTheDistanceBetweenPointsOnASquare();

        // Test 1
        int[][] p1 = {{0,2},{2,0},{2,2},{0,0}};
        System.out.println(solver.maxDistance(2, p1, 4)); // 2

        // Test 2
        int[][] p2 = {{0,0},{1,2},{2,0},{2,2},{2,1}};
        System.out.println(solver.maxDistance(2, p2, 4)); // 1

        // Test 3
        int[][] p3 = {{0,0},{0,1},{0,2},{1,2},{2,0},{2,2},{2,1}};
        System.out.println(solver.maxDistance(2, p3, 5)); // 1
    }
}