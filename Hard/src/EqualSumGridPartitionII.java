...
public class EqualSumGridPartitionII {
    ...
    public static void main(String[] args) {
        EqualSumGridPartitionII solver = new EqualSumGridPartitionII();

        int[][] grid1 = {{1,4},{2,3}};
        System.out.println(solver.canPartitionGrid(grid1)); // true

        int[][] grid2 = {{1,2},{3,4}};
        System.out.println(solver.canPartitionGrid(grid2)); // true

        int[][] grid3 = {{1,2,4},{2,3,5}};
        System.out.println(solver.canPartitionGrid(grid3)); // false

        int[][] grid4 = {{4,1,8},{3,2,6}};
        System.out.println(solver.canPartitionGrid(grid4)); // false
    }
}