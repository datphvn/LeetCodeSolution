public class MaximumPathScoreInAGrid {
    ...
    public static void main(String[] args) {
        MaximumPathScoreInAGrid solver = new MaximumPathScoreInAGrid();

        // Test 1
        int[][] grid1 = {{0, 1}, {2, 0}};
        System.out.println(solver.maxPathScore(grid1, 1)); // 2

        // Test 2
        int[][] grid2 = {{0, 1}, {1, 2}};
        System.out.println(solver.maxPathScore(grid2, 1)); // -1

        // Test 3
        int[][] grid3 = {{0}};
        System.out.println(solver.maxPathScore(grid3, 0)); // 0
    }
}